          ...
          <div className="container-yv">
            ...
            <ul style={{ listStyle: "none", margin: "48px 0 0", padding: 0, borderTop: "1px solid var(--hair)" }}>
              {d.stages.map((st, i) => {
                ...
                return (
                  <li key={st.id} className="grid items-baseline grid-cols-1 md:grid-cols-[88px_1fr_1fr]" style={{ gap: "8px 28px", padding: lime ? "30px clamp(24px,3vw,40px)" : "26px clamp(24px,3vw,40px)", borderBottom: "1px solid var(--hair)", borderRadius: 16, background: lime ? "var(--lime)" : undefined }}>
